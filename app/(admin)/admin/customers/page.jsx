// Archivo: app/(admin)/admin/customers/page.jsx
  ...
  return (
    <div className="p-4 md:p-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link href="/admin/customers/new" className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded transition-colors text-sm">
          Añadir Cliente
        </Link>
      </div>
                ...
                <tr key={customer.id} className="border-b border-gray-800 hover:bg-gray-800/50">
                  ...
                  <td className="p-4">
                    {/* Aquí irán los botones de Ver/Editar/Eliminar */}
                     <Link href={`/admin/customers/${customer.id}`} className="text-blue-400 hover:text-blue-300 text-sm font-semibold">
    Ver Detalles
  </Link>
                  </td>
                </tr>
